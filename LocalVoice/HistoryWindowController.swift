...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    func showHistoryWindow(modelContainer: ModelContainer, engine: LocalVoiceEngine) {
    ...
    private func createHistoryWindow(modelContainer: ModelContainer, engine: LocalVoiceEngine) -> NSWindow {
