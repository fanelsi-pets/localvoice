...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.localvoice", category: "LogExporter")
    private let subsystem = "com.prakashjoshipax.localvoice"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== LocalVoice Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "LocalVoice_Logs_\(timestamp).log"
