...
final class LicenseManager {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.localvoice", category: "LicenseManager")

    private let licenseKeyIdentifier = "localvoice.license.key"
    private let trialStartDateIdentifier = "localvoice.license.trialStartDate"
    private let activationIdIdentifier = "localvoice.license.activationId"
