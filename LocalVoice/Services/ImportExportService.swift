...
class ImportExportService {
    ...
    func exportSettings(
        ...
        do {
            ...
            savePanel.nameFieldStringValue = "LocalVoice_Settings_Backup.json"
            savePanel.title = String(localized: "Export LocalVoice Settings")
    ...
    func importSettings(
        ...
        openPanel.title = String(localized: "Import LocalVoice Settings")
    ...
    private func showImportSuccessAlert(message: String, needsAPIKeyReminder: Bool) {
        DispatchQueue.main.async {
            ...
            informativeText +=
                "\n\n" + String(localized: "It is recommended to restart LocalVoice for all changes to take full effect.")
