...
enum ShellCommandEnvironment {
    private static let shellPathQueue = DispatchQueue(label: "com.prakashjoshipax.localvoice.shell.path")
    ...
    private static let pathDiscoveryCommand =
        "echo __LOCALVOICE_PATH_START__; print -r -- $PATH; echo __LOCALVOICE_PATH_END__"
    ...
    private static func discoverPATHFromShell(arguments: [String]) -> String? {
        ...
        let startMarker = "__LOCALVOICE_PATH_START__"
        let endMarker = "__LOCALVOICE_PATH_END__"
