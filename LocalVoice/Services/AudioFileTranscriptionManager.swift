...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.localvoice", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: LocalVoiceEngine, mode: ModeConfig) {
    ...
    private func processItem(
        _ item: AudioFileQueueItem, modelContext: ModelContext, engine: LocalVoiceEngine, mode: ModeConfig
    ) async {
