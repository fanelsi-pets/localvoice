    ...
    private var resourcesGrid: some View {
        LazyVGrid(
            ...
            ResourceLinkRow(
                ...
                openURL("https://trylocalvoice.com/recommended-models")
            }
            ...
            ResourceLinkRow(
                ...
                openURL("https://trylocalvoice.com/affiliate")
            }
            ...
            ResourceLinkRow(
                ...
                openURL("https://trylocalvoice.com/docs")
            }
            ...
            ResourceLinkRow(
                ...
                openURL("https://www.youtube.com/@trylocalvoice/videos")
            }
            ...
            if isLicensed {
                ResourceLinkRow(
                    ...
                    openURL("https://github.com/Beingpax/LocalVoice/releases")
                }
            } else {
                ResourceLinkRow(
                    title: "Lost Key?",
...
private struct ReportFeedbackBottomPanel: View {
    ...
    var body: some View {
        ZStack(alignment: .topTrailing) {
            VStack(spacing: 20) {
                VStack(spacing: 18) {
                    Text("Thank you for using LocalVoice")
                        .font(.system(size: 24, weight: .semibold, design: .rounded))
                        .multilineTextAlignment(.center)
                        .fixedSize(horizontal: false, vertical: true)

                    Text(
                        "Have feedback, a bug report, or something that feels off? Send a note with system information by email, or join Discord for community discussion. Every report helps make LocalVoice more reliable and easier to use."
                    )
                    .font(.callout)
                    .foregroundStyle(.secondary)
                    .multilineTextAlignment(.center)
