...
enum OnboardingExperienceCatalog {
    static let steps: [OnboardingExperienceStep] = [
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Turn your spoken note into a clean email draft with LocalVoice.",
            sampleLabel: "Sample text",
            sampleText:
        ...
        OnboardingExperienceStep(
            ...
            title: "Try Rewrite",
            subtitle:
                "Select the text on the screen, tell LocalVoice the changes you want, and LocalVoice will rewrite the text for you.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Ask quick questions and LocalVoice will serve you the answers.",
