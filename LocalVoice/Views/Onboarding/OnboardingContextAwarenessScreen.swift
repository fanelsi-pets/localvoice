...
struct OnboardingContextAwarenessScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            title: "LocalVoice is Context-Aware",
            subtitle: "LocalVoice automatically understands what you are working with and selects your preferred setup.",
    ...
    var body: some View {
        ZStack {
            VStack(spacing: 18) {
                ...
                VStack(spacing: 10) {
                    Text("LocalVoice is context-aware.")
                    ...
                    Text(
                        "LocalVoice automatically understands what you are working with and selects your preferred setup. You can always configure this by editing or creating new modes."
                    )
                    .font(.system(size: 15))
...
private struct ContextAwarenessCenterSlot: View {
    var body: some View {
        ContextAwarenessModeVisual()
            ...
            .accessibilityLabel(
                "LocalVoice modes include Dictation, Enhance, Email, Assistant, Rewrite, Ask, Summarize, and Translate.")
    }
}
