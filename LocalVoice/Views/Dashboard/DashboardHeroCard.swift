...
struct DashboardHeroCard: View {
    ...
    private var styledHeadline: AttributedString {
        ...
        switch headline {
        case .calculatingProgress:
            highlightedValue = String(localized: "LocalVoice progress")
        ...
        case .savedTime(let value):
            ...
            text = AttributedString(localized: "You have saved \(highlightedValue) with LocalVoice")
        }
    ...
    private var lockedInsightsPrompt: some View {
        HStack(alignment: .center, spacing: 14) {
            ...
            Text("Continue using LocalVoice to unlock stats and insights.")
