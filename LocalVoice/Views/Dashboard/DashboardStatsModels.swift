...
enum DashboardInsightPeriod: String, CaseIterable, Identifiable, Sendable {
    ...
    var timeSavedContext: LocalizedStringKey {
        switch self {
        case .today: return "with LocalVoice today"
        case .lastSevenDays: return "with LocalVoice this week"
        case .lastThirtyDays: return "with LocalVoice over the last 30 days"
        case .thisYear: return "with LocalVoice this year"
        case .allTime: return "with LocalVoice"
        }
    }
