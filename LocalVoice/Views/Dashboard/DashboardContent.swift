...
struct DashboardContent: View {
    private let logger = Logger(subsystem: "com.prakashjoshipax.localvoice", category: "DashboardContent")
    ...
    private var insightsActionHelp: String {
        ...
        return String(localized: "Continue using LocalVoice to unlock these stats.")
    }
    ...
    private var licenseStatusMessage: some View {
        ...
        case .unlicensed:
            TrialMessageView(
                message: Text("Activate a license to continue using LocalVoice."),
    ...
    private var headerSubtitle: String {
        guard hasLoadedStatsSnapshot else {
            return String(localized: "Pulling together your LocalVoice activity.")
        }
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                Text("Required for LocalVoice shortcuts and app-wide controls to work properly.")
                    .font(.system(size: 11))
...
private struct LocalVoiceHomeFlow: View {
    ...
    private var activeColor: Color {
        ...
        case .transcribing, .enhancing, .busy: return AppTheme.Accent.primary
        case .idle: return AppTheme.Accent.primary
        }
    }
