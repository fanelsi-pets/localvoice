...
struct ModeView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            AppScreenHeader(
                title: "Modes",
                infoMessage: "Modes help you set up LocalVoice for different writing tasks, workflows, and scenarios.",
                infoURL: "https://trylocalvoice.com/docs/modes"
            ) {
                headerControls
            }
                                ...
                                VStack(spacing: 24) {
                                    ...
                                    VStack(spacing: 16) {
                                        ...
                                        VStack(spacing: 8) {
                                            ...
                                            Text(
                                                "Create first mode to automate your LocalVoice workflow based on apps/website you are using"
                                            )
                                            .font(.system(size: 14))
