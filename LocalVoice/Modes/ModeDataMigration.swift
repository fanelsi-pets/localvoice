...
extension ModeManager {
    ...
    func migrateLoadedModeConfigurationsIfNeeded() {
        ...
        for index in configurations.indices {
            ...
            let unavailableBundledDefaults: Set<String> = [
            ...
            if config.selectedTranscriptionModelName == nil
                || unavailableBundledDefaults.contains(config.selectedTranscriptionModelName ?? "")
            {
                config.selectedTranscriptionModelName = StarterModeFactory.defaultTranscriptionModelName
                config.isRealtimeTranscriptionEnabled = false
                changedConfig = true
            }
